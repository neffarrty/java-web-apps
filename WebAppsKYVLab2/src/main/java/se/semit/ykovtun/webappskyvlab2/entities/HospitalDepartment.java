package se.semit.ykovtun.webappskyvlab2.entities;
...
public class HospitalDepartment {
    ...
    public HospitalDepartment(String name, String shortName, String code, Integer floor, Integer count) {
        this.name = name;
        this.shortName = shortName;
        this.codeBuilding = code;
        this.floor = floor;
        this.boxCount = count;
    }
}
